...
3\. Copy this into a file called ~/.vim/plugin/cscope\_maps.vim:
...
![cscope_status_bar_in_progress_2](cscope_status_bar_in_progress_2.png)

Until it completes:

![cscope_status_complete_3](cscope_status_complete_3.png)
...
...from ~/.vim/plugin/cscope\_maps.vim

7\. Type the # of the result.

Example

Type **2** to jump to **cdns\_wdt\_probe**

```
Cscope tag: cdns_wdt_probe
   #   line  filename / context / line
   1    467  drivers/watchdog/cadence_wdt.c <<GLOBAL>>
             .probe = cdns_wdt_probe,
   2    287  drivers/watchdog/cadence_wdt.c <<cdns_wdt_probe>>
