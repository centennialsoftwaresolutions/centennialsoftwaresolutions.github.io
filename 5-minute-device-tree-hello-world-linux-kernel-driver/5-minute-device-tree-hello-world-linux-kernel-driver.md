...
This post shows you how to build a Linux kernel driver that reads from the device-tree in 5 min.
...
{                                                                               
        ...
        if (ret == 0)                                                           
                ...
                printk(">>>>>>>>>> ERROR! Could not read model <<<<<<<<<<\n");  
...
You should see (look for >>>>>>>>>> Hello, ARM Versatile PB <<<<<<<<<<):
...
Linux version 4.10.6 (zpfeffer@z) (gcc version 5.4.0 20160609 (Ubuntu/Linaro 5.4.0-6ubuntu1~16.04.9) ) #19 Fri Jan 4 17:49:54 MST 2019
...
Virtual kernel memory layout:
    ...
    modules : 0xbf000000 - 0xc0000000   (  16 MB)
      .text : 0xc0008000 - 0xc034e640   (3354 kB)
...
Calibrating delay loop... 336.69 BogoMIPS (lpj=1683456)
...
rtc-ds1307 0-0068: setting system clock to 2019-01-05 00:50:09 UTC (1546649409)
